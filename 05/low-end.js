import { assert, filter_pserv, minutes_to_milliseconds, network, Player, Server } from "./libbnr.js";
...
/**
 * Use our home server to hack any new low-end servers that we can now compromise.
 * 
 * @param ns The Netscript API.
 ...
 * The script figures out how many threads to use to hack a low-end server.
 * 
