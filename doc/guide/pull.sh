...
# Generate the script doc/guide/pull.js, which is used to download all sample
# scripts into our game.

# Output JavaScript code to this file.
SCRIPT=doc/guide/pull.js && declare -r SCRIPT
...
// NOTE: This script is auto-generated by doc/guide/pull.sh.
...
/**
 * The directory structure under "doc/guide/script/" on github.com.
 *
 * @returns {array<string>} All sample scripts under the directory
 *     "doc/guide/script/" on github.com.
 */
function dir_structure() {
    const filesystem = [
        // Insert directory tree here.  Should contain all sample scripts.
EOF

# The tree structure of script files.
find doc/guide/script/ | grep "\.js" | sed s/^"doc\/guide\/script\/"/'        "'/g | sed s/$/'",'/g >> "$SCRIPT"
 ...
 *
 * quacksouls/bitburner/doc/guide/script
 *
 * into the game.
 *
 * Usage: run pull.js
...
export async function main(ns) {
    ...
    const quack = "quacksouls/bitburner/main/doc/guide/script/";
